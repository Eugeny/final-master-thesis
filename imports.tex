...
\ifthenelse{\boolean{\biber}}{
  ...
  \usepackage[style=authoryear,natbib=true,backend=biber,mincitenames=1,maxcitenames=1,maxbibnames=99,uniquelist=false,dashed=false,autocite=footnote]{biblatex}
